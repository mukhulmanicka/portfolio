...
const AceternityIcon = ({order }: {order: string}) => {
  return (
    ...
    <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-5 ring-1 ring-white/10 text-2xl font-bold">
        <span>
            {order}
        </span>
        <svg
